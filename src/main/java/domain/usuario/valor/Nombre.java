...
public class Nombre implements ValueObject<domain.usuario.valor.Nombre.Props> {
    ...
    @Override
    public domain.usuario.valor.Nombre.Props value() {
        return new domain.usuario.valor.Nombre.Props() {
            @Override
